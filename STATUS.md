...
_Auto-generated 2026-05-31 17:36:30 local. Updated every ~10 min by `weekend_run.ps1`._

## State: COMPLETE - final.pt saved

| Metric | Value |
|---|---|
| Tokens seen | 0M / 3000M (0.0%) |
| Step | 0 |
| Latest loss | nan |
| Avg loss (last 30 logged) | nan |
| Throughput | 0 tok/s |
| ETA to 3B tokens | unknown |
